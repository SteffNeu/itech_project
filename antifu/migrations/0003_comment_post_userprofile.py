# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-06 11:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='antifu.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('comments', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='antifu.Comment')),
                ('post', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='antifu.Post')),
